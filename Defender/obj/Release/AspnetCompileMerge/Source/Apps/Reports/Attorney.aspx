...
Apply Filter
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="text-right">
                <asp:LinkButton ID="lbArea" runat="server" ToolTip="Area Chart"><i class="fa fa-area-chart" style="font-size:24px"></i></asp:LinkButton>
                <asp:LinkButton ID="lbBar" runat="server" ToolTip="Bar Chart"><i class="fa fa-bar-chart" style="font-size:24px"></i></asp:LinkButton>  
                <asp:LinkButton ID="lbTable" runat="server" ToolTip="Grid View"><i class="fa fa-table" style="font-size:24px"></i></asp:LinkButton> 
            </div>
        </div>
    </div>
    ...
    <telerik:RadHtmlChart runat="server" Width="100%" ID="chartColumn"
        DataSourceID="odsAssignmentCounts" Transitions="true" Visible="False" Height="300px">
        <Appearance>
            <FillStyle BackgroundColor="Transparent"></FillStyle>
        </Appearance>
        <ChartTitle>
        ...
        <PlotArea>
            <Series>                
                <telerik:ColumnSeries DataFieldY="Assignments" Name="New Assignments" VisibleInLegend="true" Visible="true" >
                    <TooltipsAppearance DataFormatString="{0} new assignments" />
                    <LabelsAppearance DataFormatString="{0}" Visible="false"></LabelsAppearance>
                </telerik:ColumnSeries>
                <telerik:ColumnSeries DataFieldY="ClosedCases" Name="Assignments Closed" VisibleInLegend="true" Visible="true">
                    <TooltipsAppearance Color="White" DataFormatString="{0} assignments closed" />
                    <LabelsAppearance DataFormatString="{0}" Visible="false"></LabelsAppearance>
                </telerik:ColumnSeries>
                <telerik:ColumnSeries DataFieldY="BailOnly" Name="Bail Only" VisibleInLegend="true" Visible="true">
                    <TooltipsAppearance DataFormatString="{0} bail only cases" />
                    <LabelsAppearance DataFormatString="{0}" Visible="false"></LabelsAppearance>
                </telerik:ColumnSeries>
                <telerik:ColumnSeries DataFieldY="ProbationViolations" Name="Probation Violations" VisibleInLegend="true" Visible="true">
                    <TooltipsAppearance DataFormatString="{0} probation violation cases" />
                    <LabelsAppearance DataFormatString="{0}" Visible="false"></LabelsAppearance>
                </telerik:ColumnSeries>
                <telerik:ColumnSeries DataFieldY="TotalCases" Name="Total Cases" VisibleInLegend="true" Visible="true">
                    <TooltipsAppearance DataFormatString="{0} total cases" />
                    <LabelsAppearance DataFormatString="{0}" Visible="false"></LabelsAppearance>
                </telerik:ColumnSeries>
            </Series>
    ...
    <telerik:RadGrid ID="chartGrid" runat="server" AutoGenerateColumns="False" DataSourceID="odsAssignmentCounts" Visible="false"
       AllowMultiRowSelection="true"
                            ClientSettings-Selecting-AllowRowSelect="true">
        <GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        <MasterTableView AutoGenerateColumns="False" DataSourceID="odsAssignmentCounts" ShowFooter="true" ShowGroupFooter="true" CommandItemDisplay="Top">
            <Columns>
                <telerik:GridBoundColumn UniqueName="CountYear" DataField="CountYear" HeaderText="Year" ReadOnly="true" FooterText="Total: "></telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="Assignments" DataField="Assignments" HeaderText="Assignments" ReadOnly="true" Aggregate="Sum" FooterText=" "></telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="ProbationViolations" DataField="ProbationViolations" HeaderText="Probation Violations" ReadOnly="true" Aggregate="Sum" FooterText=" "></telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="BailOnly" DataField="BailOnly" HeaderText="Bail Only" ReadOnly="true" Aggregate="Sum" FooterText=" "></telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="ClosedCases" DataField="ClosedCases" HeaderText="Closed Cases" ReadOnly="true" Aggregate="Sum" FooterText=" "></telerik:GridBoundColumn>
                <telerik:GridBoundColumn UniqueName="TotalCases" DataField="TotalCases" HeaderText="Total Cases" ReadOnly="true" Aggregate="Sum" FooterText=" "></telerik:GridBoundColumn>
            </Columns>
           <FooterStyle Font-Bold="true"  />
            <CommandItemSettings  ShowExportToPdfButton="True" ShowExportToWordButton="True" ShowExportToCsvButton="True"  ShowRefreshButton="false"  ShowAddNewRecordButton="False" />
        </MasterTableView>
    </telerik:RadGrid>
