...
Public Class Attorney
    ...
    Private Sub Apps_Reports_Attorney_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsNothing(Request.QueryString("attorneyguid")) AndAlso Request.QueryString("attorneyguid") <> "" AndAlso Not Page.IsPostBack Then
            ...
            chartArea.PlotArea.Series.Item(2).Visible = False
            chartArea.PlotArea.Series.Item(3).Visible = False
            chartArea.PlotArea.Series.Item(4).Visible = False
        ...
        lblTitle.Text = chartArea.ChartTitle.Text
    ...
    Private Sub gridCaseSearch_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles gridCaseSearch.ItemCommand
