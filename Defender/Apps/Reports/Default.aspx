...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="row">
        <div class="col-sm-6">
            <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target=".cpcs-calender-modal-lg">
...
Apply Filter
    ...
    <telerik:RadTabStrip RenderMode="Classic" ID="tabstripCharts" runat="server" MultiPageID="multipageCharts"
        ...
        <Tabs>
            <telerik:RadTab Text="Assignments" runat="server" PageViewID="Assignments" SelectedCssClass="bold" Selected="True">
            </telerik:RadTab>
            <telerik:RadTab Text="Cases" runat="server" PageViewID="Cases" SelectedCssClass="bold">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage runat="server" ID="multipageCharts" RenderSelectedPageOnly="true" SelectedIndex="0">
        <telerik:RadPageView ID="pageviewAssignments" runat="server" Selected="true">
            <telerik:RadHtmlChart runat="server" Width="100%" ID="chartAreaUnitAssignments"
                DataSourceID="dsAssignmentsByUnitsMetrics" Transitions="true">
                <Appearance>
...
<LineAppearance LineStyle="Smooth"  />
            ...
            <telerik:RadHtmlChart runat="server" Width="100%" ID="chartLineOfficeAssignments"
                DataSourceID="dsAssignmentsByOfficesMetrics" Transitions="true">
                <Appearance>
                    <FillStyle BackgroundColor="Transparent"></FillStyle>
                </Appearance>
                <ChartTitle>
...
<MarkersAppearance MarkersType="Circle" Size="10"></MarkersAppearance>
        ...
        <telerik:RadPageView ID="pageviewCases" runat="server">
            <telerik:RadHtmlChart runat="server" Width="100%" ID="ChartAreaUnitCases"
                DataSourceID="dsCasesByUnitsMetrics" Transitions="true">
                <Appearance>
                    <FillStyle BackgroundColor="Transparent"></FillStyle>
                </Appearance>
                <ChartTitle>
...
<LineAppearance LineStyle="Smooth"  />
            ...
            <telerik:RadHtmlChart runat="server" Width="100%" ID="ChartLineOfficeCases"
                DataSourceID="dsCasesByOfficesMetrics" Transitions="true">
                <Appearance>
                    <FillStyle BackgroundColor="Transparent"></FillStyle>
                </Appearance>
                <ChartTitle>
...
<MarkersAppearance MarkersType="Circle" Size="10"></MarkersAppearance>
    ...
    <telerik:RadTabStrip RenderMode="Classic" ID="tabstripGroupedMetrics" runat="server" MultiPageID="multipageGroupedMetrics"
        SelectedIndex="0" AutoPostBack="True">
        <Tabs>
            <telerik:RadTab Text="Units" runat="server" PageViewID="UnitGroup" SelectedCssClass="bold" Selected="True">
            </telerik:RadTab>
            <telerik:RadTab Text="Offices" runat="server" PageViewID="OfficeGroup" SelectedCssClass="bold">
            </telerik:RadTab>
            <telerik:RadTab Text="Group by Offices/Units" runat="server" PageViewID="OfficeUnitGroup" SelectedCssClass="bold">
            </telerik:RadTab>
            <telerik:RadTab Text="Group by Units/Offices" runat="server" PageViewID="UnitOfficeGroup" SelectedCssClass="bold">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
...
HeaderStyle-HorizontalAlign="Center">
    ...
    <telerik:RadTabStrip RenderMode="Classic" ID="tabstripDetails" runat="server" MultiPageID="multipageDetails"
        SelectedIndex="0" AutoPostBack="True">
        <Tabs>
            <telerik:RadTab Text="Assignments" runat="server" PageViewID="AssignmentDetailsGroup" SelectedCssClass="bold" Selected="True">
            </telerik:RadTab>
            <telerik:RadTab Text="Cases" runat="server" PageViewID="CaseDetailsGroup" SelectedCssClass="bold">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
...
ORDER BY UnitTypeName"
    ...
    <asp:SqlDataSource ID="dsAssignmentsByOfficesMetrics" runat="server" ConnectionString="<%$ ConnectionStrings:ZenoConnectionString %>" SelectCommand="SELECT OfficeName, sum(ActiveAtStart) ActiveAtStart, sum(ActiveAtEnd) as ActiveAtEnd, sum(BailOnlyAssigned) as BailOnlyAssigned, sum(ProbationViolationAssigned) as ProbationViolationAssigned, sum(Assigned) as Assigned, sum(UnAssigned) as UnAssigned, sum(TotalCasesTouched) as TotalCases FROM [dbo].[FN_Metrics_Assignments](@StartDate,@EndDate) WHERE (ActiveAtStart + ActiveAtEnd + BailOnlyAssigned + ProbationViolationAssigned + Assigned + UnAssigned + totalCasesTouched > 0)
GROUP BY OfficeName
ORDER BY OfficeName"
        EnableCaching="true">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="dsCasesByOfficesMetrics" runat="server"
        ConnectionString="<%$ ConnectionStrings:ZenoConnectionString %>"
        SelectCommand="SELECT OfficeName, sum(ActiveAtStart) ActiveAtStart, sum(ActiveAtEnd) as ActiveAtEnd, sum(NewBailOnly) as BailOnly, sum(NewProbationViolation) as ProbationViolation, sum(NewlyOpenedCases) as 'NewCases', sum(ClosedCases) as ClosedCases, sum(totalCases) as TotalCases FROM [dbo].[FN_Metrics_Cases](@StartDate,@EndDate) WHERE (ActiveAtStart + ActiveAtEnd + NewBailOnly + NewProbationViolation + NewlyOpenedCases + ClosedCases + totalCases > 0) GROUP BY OfficeName ORDER BY OfficeName"
        EnableCaching="true">
        <SelectParameters>
            <asp:ControlParameter ControlID="dteStartDate" Name="StartDate"
                PropertyName="SelectedDate" Type="DateTime" />
