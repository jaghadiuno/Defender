...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12">
            ...
            <label class="sr-only" for="exampleInputAmount">Enter a first and/or last name of person to search for</label>
    ...
    <div class="row-spacer clearfix"></div>
        ...
        <telerik:RadAjaxPanel ID="CPCSAjaxifiedPanel" runat="server" LoadingPanelID="CPCSDefaultLoadingPanel">
    ...
    <asp:Panel ID="SearchPanel" runat="server" CssClass="" Visible="false">
    ...
    <asp:ObjectDataSource ID="odsStates" runat="server" TypeName="Defender.CPCSLocations" SelectMethod="getStates" EnableCaching="true"></asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="odsParticipants"
        runat="server"
        TypeName="Defender.PeopleSearch"
        SelectMethod="getParticipantNames">
